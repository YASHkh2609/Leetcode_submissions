...
private: 
    ...
    //     return NULL;
    // }
    TreeNode* get_parent_ptr(TreeNode* root, unordered_map<TreeNode*, TreeNode*>&parent_ptr,TreeNode * target ){
        queue<TreeNode*>q;
        q.push(root);
...
public:
    vector<int> distanceK(TreeNode* root, TreeNode* target, int k) {
        ...
        TreeNode * newroot = get_parent_ptr(root, parent_ptr, target);
